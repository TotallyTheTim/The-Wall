...
<div id="main_upload" style="display: grid;grid-template-columns: 1fr">
    ...
    <div style="min-width: 200px; margin: 0 auto">
        ...
        <form method="POST" action="home.php" enctype="multipart/form-data">
            ...
            <div>
                <input type="hidden" name="madeby" id="madeby" value="<?php echo $username; ?>">
      <textarea
              id="text"
              cols="40"
              rows="4"
              name="image_text"
              placeholder="Geef hier de title van je foto."></textarea>
            </div>
            <div>
                <center><button style="padding 10px;width: fit-content;border-radius:10px;margin: 0 auto;" type="submit" name="upload">Upload!</button></center>
            </div>
